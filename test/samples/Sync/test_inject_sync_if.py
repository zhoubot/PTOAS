    ...
    with Context() as ctx:
        ...
        with Location.unknown(ctx):
            ...
            with InsertionPoint(entry):
                ...
                # Initialize ub0/ub1 from GM. Only ub1 is conditionally
                # overwritten by a PIPE_V op; store is unconditional.
                pto.TLoadOp(None, sv_in, ub0)
                pto.TLoadOp(None, sv_in, ub1)
